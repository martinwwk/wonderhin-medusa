...
/**
 * Gets the current locale from cookies (set by middleware based on URL)
 */
// Gets the current locale from cookies (set by middleware based on URL path).
 ...
 */
// Sets the locale cookie to the given value.
 ...
 */
// Updates the locale preference in cookies and backend, and updates the cart if it exists.
