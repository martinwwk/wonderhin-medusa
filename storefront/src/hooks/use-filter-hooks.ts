...
export const useFilters = () => {
    ...
    /**
     * Batch update multiple filter values at once (e.g. parent toggling all children).
     */
    const handleBatchFilterChange = (section: 'categories' | 'colors' | 'sizes', updates: Record<string, boolean>) => {
        setSelectedFilters((prev) => ({
            ...prev,
            [section]: {
                ...prev[section],
