...
const BackToTopButton: React.FC = () => {
    ...
    return (
        <div onClick={handleClick}
             className={cn(
                 "fixed bottom-40 md:bottom-20 end-5 z-[40] flex content-center items-center cursor-pointer rounded-full  ",
                 "w-12  h-12 bg-white drop-shadow-lg overflow-hidden  transition ease-in-out duration-200",
