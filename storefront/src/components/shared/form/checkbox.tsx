...
const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
    ({ className, checked, indeterminate, onCheckedChange, label, ...props }, ref) => {
                ...
                <div className="relative">
                    ...
                    <div
                        className={cn(
                            ...
                            isActive ? `${colorMap[selectedColor].bg} ${colorMap[selectedColor].border}` : "bg-white",
                    ...
                    >
                        {indeterminate && !isChecked && <Minus className="h-3 w-3 text-white" />}
