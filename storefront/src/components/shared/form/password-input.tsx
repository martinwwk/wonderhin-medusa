...
const classes = {
    root: 'py-2 px-4 md:px-5 w-full bg-white appearance-none transition duration-150 ease-in-out border text-input text-13px lg:text-sm font-body rounded-full placeholder-[#B3B3B3] transition duration-200 ease-in-out text-brand-dark border-border-two focus:border-1 focus:outline-none focus:ring-0 focus:border-gray-400 h-11 ',
};
