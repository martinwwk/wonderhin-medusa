...
const variantClasses = {
  normal:
    ' border border-gray-200 focus:shadow focus:outline-none focus:border-gray-400 focus:ring-3 focus:ring-black/5',
  solid:
  ...
  return (
    <div className={className}>
      ...
      <textarea
        ...
        name={name}
        className={cn(
          'px-4 py-3 flex items-center w-full rounded-2xl appearance-none transition duration-300 ease-in-out text-brand-dark text-13px lg:text-sm focus:outline-none focus:ring-0 placeholder-[#999]',
          shadow && 'focus:shadow',
