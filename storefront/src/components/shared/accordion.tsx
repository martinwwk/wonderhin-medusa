...
import {CollapseProps} from "@/types/template";
                ...
                <Disclosure as="div">
                    {() => ( // Removed { open } since it's unused
                        <>
                            <DisclosureButton
                                className={cn(
                                    "border-b-1 border-border-base  flex justify-between w-full py-4 text-base font-semibold  focus:outline-none hover:text-black",
