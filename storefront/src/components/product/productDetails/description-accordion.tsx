                ...
                <Disclosure key={key}  as="div">
                    {({ open }) => (
                        <>
                            <DisclosureButton
                                className={cn(
                                    "border-b-1 border-border-base  flex justify-between w-full py-4 text-base font-semibold  focus:outline-none ",
                                    open ? `${colorMap[selectedColor].link} ` : `text-brand-dark ${colorMap[selectedColor].hoverLink}`
                                )}
                            >
