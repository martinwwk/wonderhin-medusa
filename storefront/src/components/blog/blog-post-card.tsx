...
import {Blog, Tag} from "@/types/template";
...
const BlogPostCard: React.FC<BlogProps> = ({ blogData, className }) => {
  ...
  return (
    ...
    >
        ...
        >
          <div className="card-img-container rounded-xl  overflow-hidden flex mx-auto relative ">
            <Image
      ...
      <div className="pb-10 h-full relative text-center">
        <div className={cn("text-base font-semibold mb-2.5 text-gray-500")}>
          {category}
        </div>
