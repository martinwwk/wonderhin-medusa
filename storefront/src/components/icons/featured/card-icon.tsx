...
const CardIcon: React.FC<IconType> = ({
                      color = 'currentColor',
                      width = '48',
                      height = '48',
                      className = '',
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 512 512" className={cn(className, color)}
             xmlns="http://www.w3.org/2000/svg">
            <path fill={'currentColor'} stroke="currentColor" strokeWidth="2"
