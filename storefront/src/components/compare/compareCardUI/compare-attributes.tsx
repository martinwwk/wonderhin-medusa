        ...
        <div className="px-4 md:px-6 pb-6">
            <div className="mt-4 space-y-4 text-sm">
                <div className="flex gap-2">
                    <span className="font-medium md:min-w-24">{t('availability')}</span>
                ...
                <div className="flex gap-2">
                    <span className="font-medium md:min-w-24">{t('brand')}</span>
                    <span>{brand || unit || "-"}</span>
                </div>
                {model && (
                    <div className="flex gap-2">
                        <span className="font-medium md:min-w-24">{t('model')}</span>
                        <span>{model}</span>
                    </div>
                )}
                {operating && (
                    <div className="flex gap-2">
                        <span className="font-medium md:min-w-24">{t('os')}</span>
                        <span>{operating}</span>
                    </div>
                )}
                {screen && (
                    <div className="flex gap-2">
                        <span className="font-medium md:min-w-24">{t('screen')}</span>
                        <span>{screen}</span>
                    </div>
                )}
                <div className="flex gap-2">
                    <span className="font-medium md:min-w-24">{t('storage')}</span>
