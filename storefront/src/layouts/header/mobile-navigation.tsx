...
const CartButton = dynamic(() => import('@/layouts/header/btn-cart'), {ssr: false,});
...
export default function BottomNavigation() {
    ...
    const isMobileView = useMemo(() => width! < 1280, [width]);

    return (isMobileView && (
            <>
                <div
                    className="lg:hidden fixed z-30 -bottom-0.5 flex items-center justify-between
                     drop-shadow-mobileNavigation body-font bg-white/90 backdrop-blur-[2px] w-full h-14 px-4 md:px-6 lg:px-8  pb-0.5"
                >
